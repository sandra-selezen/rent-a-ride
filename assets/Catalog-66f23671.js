import{s as b,j as d,r as B,a as qe}from"./index-035892c8.js";const We=b.li`
  width: 274px;
`,ve=b.div`
  position: relative;
  margin-bottom: 14px;
...
`),s=o[0].split(": ")[1],c=(p=>p.toString().replace(/\B(?=(\d{3})+(?!\d))/g,","))(e.mileage);return d.jsxs(d.Fragment,{children:[d.jsx(et,{children:d.jsx(tt,{src:e.img?e.img:we,alt:e.make})}),d.jsxs(nt,{children:[e.make," ",d.jsx(xe,{children:e.model}),", ",e.year]}),d.jsxs(rt,{children:[n," | ",r," | Id: ",e.id," | Year: ",e.year," | Type: ",e.type," | Fuel Consumption: ",e.fuelConsumption," | Engine Size: ",e.engineSize," "]}),d.jsx(ot,{children:e.description}),d.jsxs(st,{children:[d.jsx(it,{children:"Accessories and functionalities:"}),d.jsxs(at,{children:[e.accessories.join(" | ")," | ",e.functionalities.join(" | ")]})]}),d.jsxs(ct,{children:[d.jsx(lt,{children:"Rental Conditions:"}),d.jsxs(ut,{children:[d.jsxs(_,{children:["Minimum age: ",d.jsx("span",{children:s})]}),o.slice(1).map((p,l)=>d.jsx(_,{children:p},l)),d.jsxs(_,{children:["Mileage: ",d.jsx("span",{children:c})]}),d.jsxs(_,{children:["Price: ",d.jsx("span",{children:e.rentalPrice})]})]})]}),d.jsx(dt,{children:"Rental car"})]})},pt=b.div`
  position: fixed;
  z-index: 100;
  top: 0;
  left: 0;
...
`,bt=document.getElementById("modal-root"),gt=({isOpen:e,onClose:t,children:n})=>{B.useEffect(()=>{e?document.body.style.overflow="hidden":document.body.style.overflow="auto";const s=i=>{i.code==="Escape"&&t()};return document.addEventListener("keydown",s),()=>{document.body.style.overflow="auto",document.removeEventListener("keydown",s)}},[e,t]);const r=s=>{e&&s.target===s.currentTarget&&t()},o=()=>{t()};return e?qe.createPortal(d.jsx(pt,{onClick:r,children:d.jsxs(ht,{children:[d.jsx(mt,{"aria-label":"Close modal window",onClick:o,children:d.jsx(yt,{height:24,width:24,children:d.jsx("use",{href:Ee+"#icon-close"})})}),n]})}),bt):null},xt=({car:e})=>{const[t,n]=B.useState(!1),r=e.address.split(", "),o=r[1],s=r[2],i=()=>{n(!0)},c=()=>{n(!1)};return d.jsxs(d.Fragment,{children:[d.jsxs(We,{children:[d.jsxs(ve,{children:[d.jsx(Je,{"aria-label":"Add to favorite",children:d.jsx(Ve,{height:18,width:18,children:d.jsx("use",{href:Ee+"#icon-heart"})})}),d.jsx(Ke,{src:e.img?e.img:we,alt:e.make})]}),d.jsxs(Ge,{children:[d.jsxs(Xe,{children:[e.make," ",e.model.length<9&&d.jsx(xe,{children:e.model}),", ",e.year]}),d.jsx(Qe,{children:e.rentalPrice})]}),d.jsx(Ye,{children:d.jsxs("p",{children:[o," | ",s," | ",e.rentalCompany," | ",e.type," | ",e.id," | ",e.accessories[0]]})}),d.jsx(Ze,{onClick:i,children:"Learn more"})]}),d.jsx(gt,{isOpen:t,onClose:c,children:d.jsx(ft,{car:e})})]})},wt=b.ul`
  margin-bottom: 100px;
  display: grid;
...
`,vn=({onClick:e})=>d.jsx(qn,{children:d.jsx(Wn,{onClick:e,children:"Load more"})}),Vn=()=>{const[e,t]=B.useState(),[n,r]=B.useState(1),o=()=>{r(s=>s+1)};return B.useEffect(()=>{(async()=>{const i=await Hn(n);t(c=>c?[...c,...i]:i)})()},[n]),d.jsxs(d.Fragment,{children:[e&&d.jsx(Et,{cars:e}),d.jsx(vn,{onClick:o})]})};export{Vn as default};
